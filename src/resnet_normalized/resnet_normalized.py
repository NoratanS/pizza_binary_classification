...
task = Task.init(project_name='pizza_binary_classification', task_name='resnet_normalized', output_uri=True)
...
image = Image.open("resnet_normalized_confusion_matrix.png")
