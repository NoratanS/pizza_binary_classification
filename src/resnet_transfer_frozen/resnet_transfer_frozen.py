...
task = Task.init(project_name='pizza_binary_classification', task_name='resnet_transfer_frozen', output_uri=True)
...
# Choosing a model
model = get_model('resnet_transfer_frozen',
...
plt.savefig("resnet_transfer_frozen_confusion_matrix.png")
image = Image.open("resnet_transfer_frozen_confusion_matrix.png")
