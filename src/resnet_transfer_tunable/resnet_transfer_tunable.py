...
task = Task.init(project_name='pizza_binary_classification', task_name='resnet-transfer-tunable', output_uri=True)
...
# Choosing a model
model = get_model('resnet-transfer-tunable',
...
plt.savefig("resnet_transfer_tunable_confusion_matrix.png")
image = Image.open("resnet_transfer_tunable_confusion_matrix.png")
