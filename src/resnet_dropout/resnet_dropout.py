...
task = Task.init(project_name='pizza_binary_classification', task_name='resnet-baseline-dropout', output_uri=True)
...
# Choosing a model
model = get_model('resnet-baseline-dropout',
...
plt.savefig("resnet_dropout_confusion_matrix.png")
image = Image.open("resnet_dropout_confusion_matrix.png")
